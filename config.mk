...
LDLIBS += -lstdc++ -lm -lpthread -lprotobuf-lite -losmpbf -lz -lboost_thread -lboost_timer -lboost_system -lboost_chrono -lboost_program_options -ltbb -ltbbmalloc -ltbbmalloc -ltbbmalloc_proxy
